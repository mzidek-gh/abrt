...
void xorg_crash_info_create_dump_dir(struct xorg_crash_info *crash_info, const char *dump_location, bool world_readable, int index)
{
    time_t t = time(NULL);
    ...
    sprintf(base, "xorg-%s-%lu-%u", iso_date, (long)my_pid, index);
