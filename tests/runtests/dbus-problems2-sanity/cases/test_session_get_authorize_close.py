...
class TestSession(abrt_p2_testing.TestCase):
    ...
    def test_get_authorize_close(self):
        ...
        self.assertFalse(p2_session.getproperty("is_authorized"),
        ...
        with start_polkit_agent(self.root_bus, self.bus.get_unique_name()) as pk_agent:
            ...
            self.assertTrue(p2_session.getproperty("is_authorized"),
        ...
        self.assertFalse(p2_session.getproperty("is_authorized"), msg = "still authorized")
